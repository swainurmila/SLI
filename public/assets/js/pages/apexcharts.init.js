...
BarchartColumnChartColors && (options = {
    chart: {
        height: 350,
        type: "bar",
        toolbar: {
...
RadiachartRadialColors && (options = {
    chart: {
        height: 350,
        type: "radialBar"
    },
    ...
    series: [44, 55, 67, 83],
    labels: ["New Booking", "Approve", "Pending", "Cancel/Reject"],
...
var options, chart, DonutchartDonutColors = getChartColorsArray("donut_chart");
