...
use App\Models\Website\DarpanSishu;
...
class DarpanSishuController extends Controller
{
    public function index(Request $request, $postTypeName,$id)
    {
        $postType = DarpanSishu::all();
        $routeName = $postTypeName;
        //return view('admin.post_types.darpansishu.index',compact('postType','routeName'));
    ...
    public function create($postTypeName,$id)
    {
        ...
        $lang = Language::all();
        $routeName = $postTypeName;
        return view('admin.post_types.darpansishu.addPage',compact('lang','routeName','id'));
    }
    public function store(Request $request)
    {
        ...
        $PostType->save();
        return redirect()->route('darpansishu.index',[$request->post_type,$request->post_id]);
    }
    public function edit(Request $request,$postTypeName,$id)
    {
        $lang = Language::all();
        $postType = DarpanSishu::find($id);
        return view("admin.post_types.darpansishu.edit",compact('lang','postType','id','postTypeName'));
    }
