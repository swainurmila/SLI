...
class ContactUsController extends Controller
{
    ...
    {
        $postType = ContactUs::all();
        $routeName = $postTypeName;
        //return view('admin.post_types.contact_us.index',compact('postType','routeName'));
    ...
    public function create($postTypeName,$id)
    {
        ...
        $lang = Language::all();
        $routeName = $postTypeName;
        return view('admin.post_types.contact_us.addPage',compact('lang','routeName','id'));
    }
    public function store(Request $request)
    {
        ...
        $PostType->save();
        return redirect()->route('contact-us.index',[$request->post_type,$request->post_id]);
    }
    public function edit(Request $request,$postTypeName,$id)
    {
        $lang = Language::all();
        $postType = ContactUs::find($id);
        return view("admin.post_types.contact_us.edit",compact('lang','postType','id','postTypeName'));
    }
