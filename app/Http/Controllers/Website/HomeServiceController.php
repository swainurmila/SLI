...
class HomeServiceController extends Controller
{
    ...
    {
        $postType = HomeService::all();
        $routeName = $postTypeName;
        //return view('admin.post_types.home_service.index',compact('postType','routeName'));
    ...
    public function create($postTypeName,$id)
    {
        ...
        $lang = Language::all();
        $routeName = $postTypeName;
        return view('admin.post_types.home_service.addPage',compact('lang','routeName','id'));
    }
    public function store(Request $request)
    {
        ...
        $PostType->save();
        return redirect()->route('home-service.index',[$request->post_type,$request->post_id]);
    }
    public function edit(Request $request,$postTypeName,$id)
    {
        $lang = Language::all();
        $postType = HomeService::find($id);
        return view("admin.post_types.home_service.edit",compact('lang','postType','id','postTypeName'));
    }
