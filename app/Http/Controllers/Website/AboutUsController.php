...
class AboutUsController extends Controller
{
    ...
    {
        $postType = AboutUs::all();
        $routeName = $postTypeName;
        //return view('admin.post_types.about_us.index',compact('postType','routeName'));
    ...
    public function create($postTypeName,$id)
    {
        ...
        $lang = Language::all();
        $routeName = $postTypeName;
        return view('admin.post_types.about_us.addPage',compact('lang','routeName','id'));
    }
    public function store(Request $request)
    {
        ...
        $PostType->save();
        return redirect()->route('about-us.index',[$request->post_type,$request->post_id]);
    }
    public function edit(Request $request,$postTypeName,$id)
    {
        $lang = Language::all();
        $postType = AboutUs::find($id);
        return view("admin.post_types.about_us.edit",compact('lang','postType','id','postTypeName'));
    }
