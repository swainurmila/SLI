...
class TeamMemberController extends Controller
{
    ...
    {
        $postType = TeamMember::all();
        $routeName = $postTypeName;
        //return view('admin.post_types.team_member.index',compact('postType','routeName'));
    ...
    public function create($postTypeName,$id)
    {
        ...
        $lang = Language::all();
        $routeName = $postTypeName;
        return view('admin.post_types.team_member.addPage',compact('lang','routeName','id'));
    }
    public function store(Request $request)
    {
        ...
        $PostType->save();
        return redirect()->route('team-member.index',[$request->post_type,$request->post_id]);
    }
    public function edit(Request $request,$postTypeName,$id)
    {
        $lang = Language::all();
        $postType = TeamMember::find($id);
        return view("admin.post_types.team_member.edit",compact('lang','postType','id','postTypeName'));
    }
