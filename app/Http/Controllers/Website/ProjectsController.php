...
class ProjectsController extends Controller
{
    ...
    {
        $postType = Projects::all();
        $routeName = $postTypeName;
        //return view('admin.post_types.projects.index',compact('postType','routeName'));
    ...
    public function create($postTypeName,$id)
    {
        ...
        $lang = Language::all();
        $routeName = $postTypeName;
        return view('admin.post_types.projects.addPage',compact('lang','routeName','id'));
    }
    public function store(Request $request)
    {
        ...
        $PostType->save();
        return redirect()->route('projects.index',[$request->post_type,$request->post_id]);
    }
    public function edit(Request $request,$postTypeName,$id)
    {
        $lang = Language::all();
        $postType = Projects::find($id);
        return view("admin.post_types.projects.edit",compact('lang','postType','id','postTypeName'));
    }
