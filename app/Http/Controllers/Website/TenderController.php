...
class TenderController extends Controller
{
    public function index(Request $request, $postTypeName,$id)
    {
        ...
        //return view('admin.post_types.tender.index',compact('postType','routeName'));
    ...
    public function create($postTypeName,$id)
    {
        ...
        $lang = Language::all();
        $routeName = $postTypeName;
        return view('admin.post_types.tender.addPage',compact('lang','routeName','id'));
    }
    public function store(Request $request)
    {
        ...
        $PostType->save();
        return redirect()->route('tender-3.index',[$request->post_type,$request->post_id]);
    }
    public function edit(Request $request,$postTypeName,$id)
    {
        $lang = Language::all();
        $postType = Tender::find($id);
        return view("admin.post_types.tender.edit",compact('lang','postType','id','postTypeName'));
    }
