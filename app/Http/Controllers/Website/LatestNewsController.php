...
class LatestNewsController extends Controller
{
    ...
    {
        $postType = LatestNews::all();
        $routeName = $postTypeName;
        //return view('admin.post_types.latest_news.index',compact('postType','routeName'));
    ...
    public function create($postTypeName,$id)
    {
        ...
        $lang = Language::all();
        $routeName = $postTypeName;
        return view('admin.post_types.latest_news.addPage',compact('lang','routeName','id'));
    }
    public function store(Request $request)
    {
        ...
        $PostType->save();
        return redirect()->route('latest-news.index',[$request->post_type,$request->post_id]);
    }
    public function edit(Request $request,$postTypeName,$id)
    {
        $lang = Language::all();
        $postType = LatestNews::find($id);
        return view("admin.post_types.latest_news.edit",compact('lang','postType','id','postTypeName'));
    }
