...
use App\Models\Website\Publication;
...
class PublicationController extends Controller
{
    ...
    {
        $postType = Publication::all();
        $routeName = $postTypeName;
        //return view('admin.post_types.publication.index',compact('postType','routeName'));
    ...
    public function create($postTypeName,$id)
    {
        ...
        $lang = Language::all();
        $routeName = $postTypeName;
        return view('admin.post_types.publication.addPage',compact('lang','routeName','id'));
    }
    public function store(Request $request)
    {
        ...
        $PostType->save();
        return redirect()->route('publication.index',[$request->post_type,$request->post_id]);
    }
    public function edit(Request $request,$postTypeName,$id)
    {
        $lang = Language::all();
        $postType = Publication::find($id);
        return view("admin.post_types.publication.edit",compact('lang','postType','id','postTypeName'));
    }
