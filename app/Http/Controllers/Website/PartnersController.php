...
class PartnersController extends Controller
{
    ...
    {
        $postType = Partners::all();
        $routeName = $postTypeName;
        //return view('admin.post_types.partners.index',compact('postType','routeName'));
    ...
    public function create($postTypeName,$id)
    {
        ...
        $lang = Language::all();
        $routeName = $postTypeName;
        return view('admin.post_types.partners.addPage',compact('lang','routeName','id'));
    }
    public function store(Request $request)
    {
        ...
        $PostType->save();
        return redirect()->route('partners.index',[$request->post_type,$request->post_id]);
    }
    public function edit(Request $request,$postTypeName,$id)
    {
        
        $lang = Language::all();
        $postType = Partners::find($id);
        return view("admin.post_types.partners.edit",compact('lang','postType','id','postTypeName'));
    }
