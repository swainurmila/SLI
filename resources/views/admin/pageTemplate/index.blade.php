    ...
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>
                        PageTemplate <span class="fw-300"><i>Listing</i></span>
                    </h2>
                    <div class="panel-toolbar">
                        <a href="{{route('temp_create')}}" class="btn btn-success waves-effect waves-themed">Create</a>
                    </div>
                </div>
                <div class="panel-container show">
                    <div class="panel-content">
                        ...
                        <table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100">
                            ...
                            <tbody>
                                @foreach ($pageTemplate as $item)
                                    <tr>
                                        <td>{{ $loop->iteration }}</td>
                                        <td>{{ $item->temp_name }}</td>
                                        <td>{{ $item->temp_slug }}</td>

                                        <td>
                                            <a href="{{route('temp_destroy',[$item->id])}}"
