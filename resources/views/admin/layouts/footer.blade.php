                    ...
                    <footer class="page-footer" role="contentinfo">
                        <div class="d-flex align-items-center flex-1 text-muted">
                            <span class="hidden-md-down fw-700">2020 © Oasys by&nbsp;<a href='#' class='text-primary fw-500' title='gotbootstrap.com' target='_blank'>Oasys Tech Solutions</a></span>
                        </div>
                        <div>
                        ...
                        <div class="settings-panel">
                            ...
                            <div class="expanded theme-colors pl-5 pr-3">
                                <ul class="m-0">
                                    ...
                                    <li>
                                        <a href="#" id="myapp-14" data-action="theme-update" data-themesave data-theme="{{asset('assets/backend/css/themes/cust-theme-14.css')}}" data-toggle="tooltip" data-placement="top" title="Supernova" data-original-title="Supernova"></a>
                                    </li>
                                    <li>
                                        <a href="#" id="myapp-15" data-action="theme-update" data-themesave data-theme="{{asset('assets/backend/css/themes/cust-theme-15.css')}}" data-toggle="tooltip" data-placement="top" title="Hoki" data-original-title="Hoki"></a>
                                    </li>
                                </ul>
                            </div>
                            <hr class="mb-0 mt-4">
