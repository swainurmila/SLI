...
@section('content')
<form action="{{route('gallery.image.update',[$id])}}" method="post" enctype="multipart/form-data">
    <div class="row">
                            ...
                            <div class="tab-content p-3">
                                ...
                                <div class="tab-pane fade  {{$item->id == 1 ? 'show active' : ''}}" id="tab-{{$item->lang_short_name}}" role="tabpanel" aria-labelledby="tab-{{$item->lang_short_name}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="simpleinput" name="{{$item->lang_short_name}}_title" class="form-control" value="{{$gallery->getTranslation('title',$item->lang_short_name);}}">
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label" for="simpleinput">Add Description</label>
                                        <textarea name="{{$item->lang_short_name}}_desc" class="form-control">{{$gallery->getTranslation('description',$item->lang_short_name);}}</textarea>
                                    </div>
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            <div style="width:100%; height:200px; border:1px dashed #627ca0" class="d-flex justify-content-center align-items-center" id="img_wrap">
                                ...
                                <img alt="" id="page_img" src="{{ $gallery->gallery_image }}"
                                    style="max-width: 100%; height: 100%;">
                                    <input id="post_img" name="post_attachment" type="hidden" value="{{ $gallery->gallery_image }}">
                                @else
