...
<div class="row">
    <div class="col-xl-12">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2>
                    Language <span class="fw-300"><i>Listing</i></span>
                </h2>
                <div class="panel-toolbar">
                    <a href="{{ route('lang.create') }}" class="btn btn-success waves-effect waves-themed">Create</a>
                </div>
            </div>
                        ...
                        <tbody>
                            @foreach ($lang as $item)
                                <tr>
                                    ...
                                    <td> <img style="max-width: 30px;" src="{{ $item->lang_flag }}" alt=""></td>

                                    <td>
                                        <a href="{{route('lang.delete',[$item->id])}}"
                                            class="btn btn-sm btn-icon btn-outline-danger rounded-circle mr-1"
                                            title="Delete Record">
                                            <i class="fad fa-trash-restore-alt"></i>
                                        </a>
                                        <a href="{{ route('lang.edit', [$item->id]) }}"
