...
@section('subheading', 'create Slider')
    ...
    <div class="row">
        <div class="col-md-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>
                        Slider <span class="fw-300"><i>Create</i></span>
                    </h2>
                ...
                <div class="panel-container show">
                    <div class="panel-content mt-4 mb-4 mx-auto col-md-6">
                                ...
                                <div class="form-group row"><label
                                        ...
                                        for="lang_name">Slider Name:</label>
                                    <div class="col-lg-9">
                                        <input type="text"  id="slider" name="slider"
                                            placeholder="Slider Title"class="form-control border-info"
                                            value=""></div>
                                ...
                                {{-- <div class="form-group row"><label
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text"  id="lang_short_name" name="lang_short_name"
