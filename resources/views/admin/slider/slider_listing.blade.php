    ...
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>
                        Slider <span class="fw-300"><i>Listing</i></span>
                    </h2>
                    <div class="panel-toolbar">
                        <a href="{{ route('slider.content',[$id]) }}" class="btn btn-success waves-effect waves-themed">Create</a>
                    </div>
                </div>
                            ...
                            <tbody>
                                ...
                                @foreach ($slider as $item)
                                    <tr>
                                        ...
                                        <td> <img style="max-width: 200px;" src="{{ asset($item->slider_image)}}" alt=""> </td>

                                        <td>
                                            <a href="{{route('slider.image.delete',[$item->id])}}"
