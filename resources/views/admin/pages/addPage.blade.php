                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="form-group">
                                ...
                                <select name="page_template_id" id="" class="form-control">
    ...
    function fmSetLink($url) {
            ...
            if(extension == 'png' || extension == 'jpg' || extension == 'jpeg'){
               ...
               // const linkElement = document.getElementById(inputId).href = $url;
                ...
                btnn.remove();
                var btn_html = '<a href="'+$url+'" id="FileId" target="_blank"><img alt=""  src="{{asset('assets/backend/img/file.png')}}"></a>';
                $('#File_wrap').append(btn_html);
