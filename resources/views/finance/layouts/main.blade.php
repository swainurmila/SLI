...
<head>
    ...
    <title>SLI-finance module</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<style>
    ...
    body[data-sidebar="colored"] #finance-sidebar.vertical-menu {
        background: #172259;
    }
    ...
    .centered {
        ...
        /* Add background color to make it visible */
        padding: 20px;
        border-radius: 10px;
        ...
        <div class="main-content">
            <main class="">
                ...
                @if (session()->has('success'))
                    <div id="liveToast" class="success-box mt-2" role="alert" aria-live="assertive"
                        aria-atomic="true">
                        <h4 class="success-text"> {{ session()->get('success') }}</h4>
                    </div>
                @endif
                @if (session()->has('error'))
                    <div id="liveToast" class="error-box mt-2" role="alert" aria-live="assertive" aria-atomic="true">
                ...
                @yield('content')
                {{-- @php dd('gggggggggggggggg'); @endphp --}}
            </main>
        </div>
    </div>
