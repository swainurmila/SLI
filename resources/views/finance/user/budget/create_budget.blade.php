                ...
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <div class="page-title-left">
                            <h4>Yearly Budget Creation</h4>
                        </div>
                        <div class="page-title-right d-flex">
                            <form class="" action="{{ route('yearly-budget-creation') }}" id="budgetPlanningYearForm" method="GET">
                                <select class="form-select" name="financial_year" id="budgetPlanningYearSelect">
                        ...
                        <div class="card-body">
                            ...
                            @if (auth()->user()->can('finance-create'))
                                <form action="{{ route('yearly-budget-store') }}" method="POST" id="budget_save"
                                    ...
                                    <div class="row mb-3" style="position: relative;">
                                        ...
                                        <div class="col-3">
                                            <div class="">
                                                <label class="form-label">Financial Year<sup class="text-danger"> *</sup></label>
                                            ...
                                            <div class="">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        ...
                                                        onkeypress="return /[0-9.]/.test(event.key)" name="amount" maxlength="12"
                                                        id="amount">
                            ...
                            <div class="row">
                                <div class="mt-4 table-responsive">
                                    <table id="budget-planing-list" class="table table-bordered dt-responsive nowrap"
                                        ...
                                        <tbody>
                                            @foreach ($budget as $key => $item)
                                                <tr>
                                                    ...
                                                    <td><span class="badge bg-danger"><span class="font-size-14">₹ {{ $item->amount }}</span></span></td>
                                                    <td><span class="badge bg-warning"><span class="font-size-14">₹ {{ @$item->amount - @$item->SubCategory->expenses_sum_amount }}</span></span>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
    ...
    <script>
        ...
        $(document).ready(function() {
            if (!documentReadyExecuted) {
                ...
                $('#budget-planing-list').DataTable({
                    ...
                    buttons: [{
                        ...
                        },
                        {
                            extend: 'pdfHtml5',
                            title: function() {
                                return "Yearly Budget Sanctioned Report";
                            },
                ...
                $('#budgetPlanningYearSelect').change(function() {
                    var selectedYear = $(this).val();
                    $('#budgetPlanningYearForm').submit();
                });
                ...
                $('#budget_save').validate({
                    ...
                    messages: {
                        ...
                        subcategory_id: {
                            required: "Please select a sub-scheme"
                        },
                        financial_year: {
                ...
                $('#budget_save').submit(function(event) {
                    ...
                    if (subcategoryId && financialYear && amount) {
                        ...
                        // If any necessary field is not filled, show an alert
