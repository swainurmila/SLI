                ...
                {{-- <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <div class="page-title-left">
                            <h4>Fund | Library Transactions </h4>
                        </div>
                    </div>
                </div> --}}
                <div class="col-12">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="mt-4 table-responsive">
                                    <table id="library-report" class="table table-bordered dt-responsive nowrap"
                                        ...
                                        <tbody>
                                            @foreach ($library_data as $key=>$item)
                                                <tr>
                                                    <td>{{++$key}}</td>
