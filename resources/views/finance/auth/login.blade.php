@extends('finance.layouts.auth.finance-auth')
@section('content')
    <div class="col-md-10 col-lg-8 col-xl-5">
        <div class="card">
            <div class="card-body p-4">
                ...
                <div class="p-2">
                    <form method="POST" class="mt-3" id="finance-login-form" action="{{ route('finance.login.check') }}">
                        @csrf
