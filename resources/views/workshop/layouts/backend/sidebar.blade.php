                 ...
                 <span class="logo-lg">
                     <div class="d-flex">
                         ...
                         <span class="ms-2">
                             ...
                             <span class="logo-sm-text">WorkShop</span>
                         </span>
                     </div>
                 </span>
             </a>
     ...
     <div data-simplebar class="sidebar-menu-scroll">
         ...
         <div id="sidebar-menu">
             <ul class="metismenu list-unstyled" id="side-menu">
                 ...
                 <li>
                     <a href="{{ route('workshop.admin.dashboard') }}" class="">
                 ...
                 <li>
                    ...
                    <ul class="sub-menu" aria-expanded="true">
                        <li>
                            <a href="{{ route('workshop.users') }}" class="">
                 ...
                 <li>
                    <a href="{{ route('workshop.index') }}" class="">
                 ...
                 <li>
                    <a href="{{ route('workshop-notification-index')}}" class="">
                        <i class="fas fa-bell"></i>
                        <span>Workshop Notification</span>
                    </a>
                </li>
                <li>
                    <a href="{{route('workshop.admin.certificate.list')}}" class="">
                        <i class="fas fa-certificate"></i>
                        <span>Workshop Certificate</span>
                    </a>
                </li>
                <li>
                    <a href="{{route('workshop.transactiondetails')}}" class="">
