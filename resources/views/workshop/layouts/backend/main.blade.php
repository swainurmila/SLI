...
<head>
    ...
    <link href="{{ asset('assets/libs/datatables.net-responsive-bs4/css/responsive.bootstrap4.min.css') }}"
      ...
      {{-- ) <script src="{{ asset('assets/libs/jquery/sweetalert.js') }}"></script> --}}
...
<body data-sidebar="colored">
    ...
    <div id="layout-wrapper">
        @include('workshop.layouts.backend.header')
        @include('workshop.layouts.backend.sidebar')
    ...
    @include('workshop.layouts.backend.footer')
