                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-12 col-lg-4">
                                        ...
                                        <input class="form-control form-valid" type="text" value="" id="class_name"
                                            name="name" maxlength="20" pattern="[a-zA-Z\s]+" onkeypress="return validateKeyPress(event)">
                                    </div>
                                    <div class="col-sm-12 col-lg-4">
                                    ...
                                    <div class="col-md-12 mt-2">
                                        ...
                                        <textarea name="sch_description" id="sch_description" class="form-control" placeholder="Add some text here...." maxlength="400"></textarea>
                                    </div>
                                    <span>
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#workshop_date').on('change', function() {
                $(this).valid();
            });
        });
