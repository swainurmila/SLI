        ...
        <div class="pm-certificate-border col-lg-12">
                    ...
                    <div class="col-lg-12">
                        <div class="row d-flex justify-content-center">
                            <div class="pm-certificate-name col-lg-8 text-center">
                                <div class="pm-certificate-text">This certify That</div>
                                <span class="pm-name-text bold large" style="color: #0e70b3;">{{ucfirst(@$user->first_name)}} {{ucfirst(@$user->last_name)}}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="row d-flex justify-content-center">
                            <div class="pm-earned col-lg-8 text-center">
                                <span class="m-2 padding-0 block">He/She has successfully conducted research culminating in a paper titled "{{@$submittedPaper->paper_title}}", which has been published in {{@$submittedPaper->subject_category}} on {{\Carbon\Carbon::parse(@$submittedPaper->publish_date)->toFormattedDateString()}}.
                                    </span>
            ...
            <div class="row d-flex justify-content-between">
                <div class="col-lg-6 pm-certified text-center">
                    ...
                    <span class="block" style="color: #4c5052;">{{\Carbon\Carbon::parse(@$submittedPaper->publish_date)->toFormattedDateString()}}</span>
                </div>
                <div class="col-lg-6 pm-certified text-center">
