                            ...
                            <div class="mb-3 row">
                                <div class="col-sm-12 col-lg-4">
                                    ...
                                    <input class="form-control" type="text" autofocus value="{{ $value->first_name }}"
                                        name="first_name"  pattern="[a-zA-Z\s]+" onkeypress="return validateKeyPress(event)" maxlength="50" required>
                                </div>
                                <div class="col-sm-12 col-lg-4">
                                    <label for="" class="col-form-label">Last Name<span
                                            class="text-danger">*</span></label>
                                    <input class="form-control" type="text" autofocus value="{{ $value->last_name }}"
                                        name="last_name"  pattern="[a-zA-Z\s]+" onkeypress="return validateKeyPress(event)" maxlength="50" required>
                                </div>
                                <div class="col-sm-12 col-lg-4">
                                    <label for="" class="col-form-label">User Name<span
                                            class="text-danger">*</span></label>
                                    <input class="form-control" type="text" autofocus value="{{ $value->user_name }}"
                                        name="user_name"pattern="[a-zA-Z\s]+" onkeypress="return validateKeyPress(event)" maxlength="50"  required>
                                </div>
                                <div class="col-sm-12 col-lg-4">
                                ...
                                <div class="col-sm-12 col-lg-4">
                                    ...
                                    <input class="form-control" type="text" autofocus
                                        value="{{ $value->contact_no }}" name="contact_no" required>
                                </div>
                                {{-- <div class="col-sm-12 col-lg-4">
                                ...
                                <div class="col-sm-12 col-lg-4">
                                    ...
                                    <select class="form-select" name="district_id"
                                        id="district_dropdown_{{ $value->id }}" required>
                                ...
                                @if ($value->status == 0 || $value->is_delete == 1)
                                    <div class="col-sm-12 col-lg-4">
                            ...
                            <div class="mb-3 row">
                                <div class="col-sm-12 col-lg-4">
                                    ...
                                    <input class="form-control" type="text" autofocus name="first_name"
                                        pattern="[a-zA-Z\s]+" onkeypress="return validateKeyPress(event)" maxlength="50"
                                        autocomplete="off">
                                ...
                                <div class="col-sm-12 col-lg-4">
                                    ...
                                    <input class="form-control" type="text" autofocus name="last_name"
                                        autocomplete="off" pattern="[a-zA-Z\s]+" maxlength="50"
                                ...
                                <div class="col-sm-12 col-lg-4">
                                    <label for="" class="col-form-label">User Name<span
                                            class="text-danger">*</span></label>
                                    <input class="form-control" type="text" autofocus name="user_name" maxlength="60"
            ...
            $("#user_details_save").validate({
                rules: {
                    ...
                    profile_photo: { // New rule for profile photo
                        ...
                        filetype: 'image/jpeg,image/png,image/webp', // Max file size 1 MB (in bytes)
                    },
                    user_mode: {
                        required: true
                    }
