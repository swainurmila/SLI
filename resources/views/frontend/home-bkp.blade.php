			...
			<div class="about-compnay section-spacing mt-5">
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-6 col-12"><img src="{{asset('sli_assets/images/home/sli-about.jpg')}}" alt="">
				...
				<div class="container">
					...
					<div class="wrapper">
						<div class="row">
                            ...
                            <div class="col-xl-4 col-md-6 col-12">
                                <div class="single-service">
                                    <div class="img-box"><img src="{{ asset($value['attachment_img']) }}" alt=""></div>
                                    <div class="text">
                                        <h5 class="service-txt"><a href="publication.html">{{$value['title']}}</a></h5>
                                        <p class="service-desc-txt">{!! $value['content'] !!}</p>
                                        <a href="/en/publication-details" class="read-more">{{$value['excerpt']}} <i class="fa fa-angle-right" aria-hidden="true"></i></a>
                                    </div>
                                </div>
                            </div>
                            @endforeach
							...
							<div class="col-xl-4 col-md-6 col-12">
								<div class="single-service">
									<div class="img-box"><img src="{{asset('sli_assets/images/home/Tender.jpg')}}" alt=""></div>
									<div class="text">
										<h5 class="service-txt"><a href="{{ route('web.inner', ['lang' => 'en', 'slug' => 'tenders']) }}">Tenders</a></h5>
										<p class="service-desc-txt">State Labor Institute's Tender Procurements</p>
										{{-- <a href="tender.html" class="read-more">READ MORE <i class="fa fa-angle-right" aria-hidden="true"></i></a> --}}
										<a href="{{ route('web.inner', ['lang' => 'en', 'slug' => 'tenders']) }}" class="read-more">READ MORE <i class="fa fa-angle-right" aria-hidden="true"></i></a>
							...
							<div class="col-xl-4 col-md-6 col-12">
								<div class="single-service">
									<div class="img-box"><img src="{{asset('sli_assets/images/home/Magazine.jpg')}}" alt=""></div>
									<div class="text">
										<h5 class="service-txt"><a href="{{ route('web.inner', ['lang' => 'en', 'slug' => 'magazine']) }}">Magazine & Journal</a></h5>
										<p class="service-desc-txt">Labour Institute's Periodical Publications</p>
										<a href="{{ route('web.inner', ['lang' => 'en', 'slug' => 'magazine']) }}" class="read-more">READ MORE <i class="fa fa-angle-right" aria-hidden="true"></i></a>
									</div> <!-- /.text -->
								</div> <!-- /.single-service -->
							</div> <!-- /.col- -->
							<div class="col-xl-4 col-md-6 col-12">
								<div class="single-service">
									<div class="img-box"><img src="{{asset('sli_assets/images/home/Research.jpg')}}" alt=""></div>
									<div class="text">
										<h5 class="service-txt"><a href="{{ route('web.inner', ['lang' => 'en', 'slug' => 'research']) }}">Research</a></h5>
										<p class="service-desc-txt">Research Initiatives on Labor Dynamics</p>
										<a href="{{ route('web.inner', ['lang' => 'en', 'slug' => 'research']) }}" class="read-more">READ MORE <i class="fa fa-angle-right" aria-hidden="true"></i></a>
									</div> <!-- /.text -->
								</div> <!-- /.single-service -->
							</div> <!-- /.col- -->
							<div class="col-xl-4 col-md-6 col-12">
								<div class="single-service">
									<div class="img-box"><img src="{{asset('sli_assets/images/home/Training.jpg')}}" alt=""></div>
									<div class="text">
										<h5 class="service-txt"><a href="{{ route('web.inner', ['lang' => 'en', 'slug' => 'training']) }}">Training Program</a></h5>
										<p class="service-desc-txt">Skills Development Programs for Workforce</p>
										<a href="{{ route('web.inner', ['lang' => 'en', 'slug' => 'training']) }}" class="read-more">READ MORE <i class="fa fa-angle-right" aria-hidden="true"></i></a>
									</div> <!-- /.text -->
								</div> <!-- /.single-service -->
							</div> <!-- /.col- -->
							<div class="col-xl-4 col-md-6 col-12">
								<div class="single-service">
									<div class="img-box"><img src="{{asset('sli_assets/images/home/infra.jpg')}}" alt=""></div>
									<div class="text">
										<h5 class="service-txt"><a href="{{ route('web.inner', ['lang' => 'en', 'slug' => 'infrastructure']) }}">Infrastructure</a></h5>
										<p class="service-desc-txt">Modern Facilities Supporting Labor Initiatives</p>
										<a href="{{ route('web.inner', ['lang' => 'en', 'slug' => 'infrastructure']) }}" class="read-more">READ MORE <i class="fa fa-angle-right" aria-hidden="true"></i></a>
									</div> <!-- /.text -->
								</div> <!-- /.single-service -->
							</div> <!-- /.col- -->
						</div> <!-- /.row -->
