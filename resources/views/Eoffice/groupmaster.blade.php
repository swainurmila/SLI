                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row mb-2">
                                <div class="col-md-10">
                                    {{-- <h4 class="card-title mb-4">Office Group List</h4> --}}
                                </div>
                                <div class="col-md-2 text-left">
                                    <button class="btn ms-auto btn-md custom-btn" type="button" data-bs-toggle="modal"
                                        data-bs-target="#addModal">Add Group</button>
                                </div>
                            </div>
                                    ...
                                    <tbody>
                                        @foreach ($group as $key => $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('delete-group', [$item->id]) }}"
                                                    ...
                                                    <form id="delete-form-{{ $item->id }}"
                                                        action="{{ route('delete-group', [$item->id]) }}" method="POST"
                                                        style="display: none;">
                                                        @csrf
                                                        @method('POST')
                                                    </form>
                                                ...
                                                <div class="modal fade" id="editTranModal{{ @$item->id }}"
                                                    ...
                                                    <div class="modal-dialog modal-l modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <form action="{{ route('update-group', $item->id) }}"
    ...
    <div class="modal fade" id="addModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-l modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('add-group') }}" method="POST" id="master_save" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                <div class="form-group">
                                    <label class="form-label">Group Name:<sup><span
                                                style="color: red;">*</span></sup></label>
