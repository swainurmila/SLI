                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($office_files as $i => $file)
                                            <tr>
                                                ...
                                                <td>
                                                    {{-- <p>{{ @$file->created_at }}</p> --}}
                                                    <p>{{ isset($file->created_at) ? $file->created_at->format('d-m-Y') :'N/A' }}</p>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <div style="display: flex">
                                                        <form action="{{ route('admin.office.delete-file-flow', ['id' => @$file->file_id]) }}" method="POST">
                                                            @csrf
                                                            <input type="hidden" name="delete_form" value="Inbox">
                                                        ...
                                                        <a href="{{ route('admin.office.view-file', ['id' => @$file->file_id]) }} "
                                                            type="button"
                                                            class="btn custom-btn waves-effect waves-light btn-sm ms-2">View</a>
                                                    </div>
                                                        {{-- <button type="button"
