                    ...
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <div class="page-title-left">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item active text-custom-primary">Sent</li>
                            </ol>
                        </div>
                                        ...
                                        @foreach ($office_files as $i => $file)
                                            <tr>
                                                ...
                                                <td>
                                                    <p>
                                                        <span
                                                            class="badge bg-danger rounded-pill">{{ @$file->toUser->first_name . ' ' . @$file->toUser->last_name }}</span>
                                                    </p>
                                                </td>
                                                <td>
                                                    <div style="display: flex">
                                                        ...
                                                        <a href="{{ route('admin.office.view-file', ['id' => @$file->file_id]) }} "
                                                            type="button"
                                                                    ...
                                                                    <div class="row mb-3">
                                                                        <div class="col-md-12">
                                                                            ...
                                                                            <textarea name="remarks" class="form-control form-valid{{ $file->id }} save-draft"
                                                                                id="remarks{{ $file->id }}" cols="10" rows="5"></textarea>
                                                                        </div>
                                                                    </div>
