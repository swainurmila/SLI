                                                            ...
                                                            <div class="modal fade" id="editModal{{ $value->id }}"
                                                                ...
                                                                <div class="modal-dialog modal-xl modal-dialog-centered"
                                                                    ...
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title"
                                                                                id="staticBackdropLabel">Approve & Reject
                                                                                Appointment</h5>
                                                                            <button type="button" class="btn-close"
                                                                            ...
                                                                            <div class="mb-3 row">
                                                                                <div class="col-sm-12 col-lg-4">
                                                                                    ...
                                                                                    <input class="form-control"
                                                                                        type="text"
                                                                                        value="{{ $value->TodUser->first_name }}"
                                                                                        readonly id="">
                                                                                </div>
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('admin.office.appointment.saveRequestAppointment') }}" method="POST"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4">
                                <label class="form-label" for="">Appointment From</label>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="date" name="from_date" class="form-control form-valid save-draft"
