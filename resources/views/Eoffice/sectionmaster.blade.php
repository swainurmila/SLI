...
@section('content')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">Office Section </h4>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row mb-2">
                                <div class="col-md-10">
                                    {{-- <h4 class="card-title mb-4">Office Section List</h4> --}}
                                </div>
                                <div class="col-md-2 text-left">
                                    <button class="btn ms-auto btn-md custom-btn" type="button" data-bs-toggle="modal"
                                        data-bs-target="#addModal">Add Section</button>
                                </div>
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form id="delete-form-{{ $item->id }}"
                                                        action="{{ route('delete-section', [$item->id]) }}" method="POST"
                                                        style="display: none;">
                                                        @csrf
                                                        @method('POST')
                                                    </form>
                                                ...
                                                <div class="modal fade" id="editTranModal{{ @$item->id }}"
                                                    ...
                                                    <div class="modal-dialog modal-l modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <form action="{{ route('update-section', $item->id) }}"
    ...
    <div class="modal fade" id="addModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-l modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('add-section') }}" method="POST" id="master_save"
                    enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                <div class="form-group">
                                    <label class="form-label">Section Name:<sup><span
                                                style="color: red;">*</span></sup></label>
    ...
    @endif -->
                            ...
                            {{-- <div class="form-group">
                                <label class="form-label">Status:<sup><span style="color: red;">*</span></sup></label>
                                <select class="form-control form-valid" name="status" id="status">
                                    <option value="1">Active</option>
                                    <option value="0">Inactive</option>
                                </select>
