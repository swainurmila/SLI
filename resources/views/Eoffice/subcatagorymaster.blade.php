            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">Office Sub Category </h4>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row mb-2">
                                <div class="col-md-10">
                                    {{-- <h4 class="card-title mb-4">Office Sub Category List</h4> --}}
                                </div>
                                <div class="col-md-2 text-left">
                                    <button class="btn ms-auto btn-md custom-btn" type="button" data-bs-toggle="modal"
                                        data-bs-target="#addModal">Add Sub Category</button>
                                </div>
                            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-centered table-nowrap mb-0">
                                    ...
                                    <tbody>
                                        @foreach ($subcatagory as $key => $item)
                                            <tr>
                                                <td>{{ ++$key }}</td>
                                                <td>{{ @$item->name }}</td>
                                                ...
                                                <td>
                                                    <a href="{{ route('delete-subcatagory', [@$item->id]) }}"
                                                    ...
                                                    <form id="delete-form-{{ @$item->id }}"
                                                        action="{{ route('delete-subcatagory', [@$item->id]) }}"
                                                ...
                                                <div class="modal fade" id="editTranModal{{ @$item->id }}"
                                                    ...
                                                    <div class="modal-dialog modal-l modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <form action="{{ route('update-subcatagory', @$item->id) }}"
                                                                        ...
                                                                        <div class="col-md-12 mb-2">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <select id="mainCategorySelect"
                                                                                    ...
                                                                                    name="main_catagory_id" required>
                                                                                    <option value="">Select Main
                                                                                        Category</option>
                                                                                    @foreach ($catagory as $val)
                                                                                        <option value="{{ $val->id }}"
                                                                                            {{ $val->id == $item->main_catagory_id ? 'selected' : '' }}>
                                                                                            {{ $val->name }}
                                                                                        </option>
                                                                                    @endforeach
                                                                                </select>
                                                                                @if ($errors->has('main_category_id'))
                                                                                    <span
                                                                                        class="text-danger">{{ $errors->first('main_category_id') }}</span>
                                                                                @endif
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-12 mb-2">
                                                                            <div class="form-group">
                                                                                <label class="form-label ">Status:<sup><span
                                                                                            style="color: red;">*</span></sup></label>
                                                                                <select
                                                                                    class="form-select form-valid{{ @$item->id }}"
                                                                                    name="status">
    ...
    <div class="modal fade" id="addModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-l modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('add-subcatagory') }}" method="POST" id="master_save"
                    enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                <div class="form-group">
                                    <label class="form-label">Main Category:<sup><span
                                                style="color: red;">*</span></sup></label>
                                    <select id="mainCategorySelect" class="form-control" name="main_catagory_id"
                                        id="main_catagory_id" required>
                                    ...
                                    @if ($errors->has('main_catagory_id'))
                                        <span class="text-danger">{{ $errors->first('main_catagory_id') }}</span>
                                    @endif
                                </div>
                            </div>
                            <div class="col-md-12 mb-2">
                                <div class="form-group">
                                    <label class="form-label">Sub Category Name:<sup><span
                                                style="color: red;">*</span></sup></label>
                                    <input type="text" id="exampleInputUsername"
                                        class="form-control form-valid name-validation" name="name"
                                        placeholder="Sub  Category Name" required="required">
                                    @if ($errors->has('name'))
                            ...
                            <div class="col-md-12 mb-2">
                                <div class="form-group">
                                    ...
                                    <select class="form-select form-valid" name="status">
                                        <option value="">Select</option>
...
<script>
    ...
    //                     $.each(result.catagory_name, function(key, value) {
    //                         $("#main_category_id").append('<option value="' + value
    //                             .id +
    //                             '">' + value.name + '</option>');
    //                     });
    //                 }
