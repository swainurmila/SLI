            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">Office Main Category</h4>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row mb-2">
                                <div class="col-md-10">
                                    {{-- <h4 class="card-title mb-4">Office Main Category List</h4> --}}
                                </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-centered table-nowrap mb-0">
                                    ...
                                    <tbody>
                                        @foreach ($maincatagory as $key => $item)
                                            <tr>
                                                <td>{{ ++$key }}</td>
                                                <td>{{ $item->name }}</td>
                                                <td>
                                                ...
                                                <td>
                                                    <a href="{{ route('delete-catagory', [$item->id]) }}"
                                                    ...
                                                    <form id="delete-form-{{ $item->id }}"
                                                        action="{{ route('delete-catagory', [$item->id]) }}" method="POST"
                                                        style="display: none;">
                                                        @csrf
                                                        @method('POST')
                                                    </form>
                                                ...
                                                <div class="modal fade" id="editTranModal{{ @$item->id }}"
                                                    ...
                                                    <div class="modal-dialog modal-l modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <form action="{{ route('update-catagory', $item->id) }}"
    ...
    <div class="modal fade" id="addModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-l modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('add-maincatagory') }}" method="POST" id="master_save"
                    enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="modal-body">
                        <div class="row">
