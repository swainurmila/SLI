                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-10">
                                    <h4 class="card-title mb-4">{{ @$training_type }}</h4>
                                </div>
                                <div class="col-md-2">
                                    <a href="{{ route('training.createTraining', ['id' => $id]) }}" class="btn ms-3 custom-btn">Add
                                        Training<span><i class="ms-2 uil-plus-circle"></i></span></a>
                                        ...
                                        <div class="table-responsive">
                                            <table id="datatable_1" class="table table-bordered dt-responsive nowrap"
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($trainings_unpaid as $key => $item)
                                                        <tr class="text-center">
                                                            <td>{{ ++$key }}</td>
                                                            <td>{{ $item->name }}</td>
                                                            {{-- <td>
                                                            ...
                                                            <td>
                                                                ...
                                                                @php
                                                                    $batches = App\Models\Training\TrBatch::with('trainingOrder')
                                                                                    ...
                                                                                    <table
                                                                                        ...
                                                                                        <tbody class="table-group-divider">
                                                                                            @foreach ($batches as $batchkey => $batch)
                                                                                                @php
                                                                                                    $class_count = App\Models\Training\TrTrainingClass::where('batch_id', @$batch->id)->count();
                                                                                                @endphp
                                        ...
                                        <div class="table-responsive">
                                            <table id="datatable_2" class="table table-bordered dt-responsive nowrap"
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($trainings_paid as $key => $item)
                                                        <tr class="text-center">
                                                            <td>{{ ++$key }}</td>
                                                            <td>{{ $item->name }}</td>
                                                            {{-- <td>
