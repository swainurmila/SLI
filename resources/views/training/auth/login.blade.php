    ...
    <div class="col-md-10 col-lg-8 col-xl-5">
        <div class="card">
            <div class="card-body p-4">
                ...
                @endif
                <div class="p-2">
                    <form method="POST" id="training-login-form" action="{{ route('training.login.check') }}">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="row">
                            ...
                            <div class="captcha col-md-5 captcha-img">
                                ...
                                {{-- <img src="{{ captcha_src('black_white') }}" alt="captcha"> --}}
                            </div>
                            <div class="col-md-2">
                        ...
                        <div class="text-center">
                            <p class="mb-0">Don't have an account ? <a href="{{ route('training.register.create') }}"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (!url.searchParams.has('reload')) {
                ...
                // Remove the 'reload' parameter after the page has loaded
