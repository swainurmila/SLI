...
@section('content')
                    ...
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <button class="btn btn-md custom-btn" type="button" data-bs-toggle="modal"
                                        data-bs-target="#addModal">Add Sponser</button>
                        </div>
        ...
        <div class="modal fade" id="editTranModal{{ @$value->id }}" data-bs-backdrop="static" data-bs-keyboard="false"
            ...
            <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('training.sponsor.update', $value->id) }}" method="POST"
                        id="sponsor_details_save{{ @$value->id }}" enctype="multipart/form-data">
                        @method('PATCH')
                        @csrf
                        <div class="modal-body">
                            <div class="mb-3 row">
                                <div class="col-sm-12 col-lg-4">
                                    ...
                                    <input class="form-control" maxlength="50"onkeypress="return /[a-z A-Z\.]/i.test(event.key)"
                                ...
                                <div class="col-sm-12 col-lg-4">
                                    <label for="" class="col-form-label">Contact No<span
                                            class="text-danger">*</span></label>
                                    <input class="form-control" maxlength="10" pattern="[6-9]\d{9}"
                                    title="Please enter a valid 10-digit contact number starting with 6, 7, 8, or 9" type="text" value="{{ $value->contact_no }}"
                                        name="contact_no">
                                </div>
                                ...
                                <div class="col-sm-12 col-lg-4">
                                    ...
                                    <img class="mt-4" src="{{ asset(@$value->profile_photo) }}"
                                        style="height: 150px;width: 355px;">
                                </div>
    ...
    <div class="modal fade" id="addModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Add Sponsor Details</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                    </button>
                </div>

                <form action="{{ route('training.sponsor.store') }}" method="POST" id="sponsor_details_save"
                        ...
                        <div class="row">
                            <div class="mb-3 row">
                                <div class="col-sm-12 col-lg-4">
                                    <label for="" class="col-form-label">First Name<span
                                            class="text-danger">*</span></label>
                                    <input class="form-control" type="text" maxlength="15" name="first_name"  onkeypress="return /[a-z A-Z\.]/i.test(event.key)"
                                ...
                                <div class="col-sm-12 col-lg-4">
                                    <label for="" class="col-form-label">Last Name<span
                                            class="text-danger">*</span></label>
                                    <input class="form-control" type="text" maxlength="50" name="last_name"  onkeypress="return /[a-z A-Z\.]/i.test(event.key)"
                                    oninput="this.value = this.value.replace(/^\s+/, '')" maxlength="50" autocomplete="off">
                                ...
                                <div class="col-sm-12 col-lg-4">
                                    <label for="" class="col-form-label">User Name<span
                                            class="text-danger">*</span></label>
                                    <input class="form-control" type="text" maxlength="60" name="user_name" onkeypress="return /[a-z A-Z\.]/i.test(event.key)"
                                    oninput="this.value = this.value.replace(/^\s+/, '')" maxlength="50" autocomplete="off">
...
@section('script')
    <script>
        $(document).ready(function() {
            ...
            $('form[id^="sponsor_details_save"]').each(function() {
                $(this).validate({
                    rules: {
                        first_name: {
                            required: true,
