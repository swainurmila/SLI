            ...
            <div class="pm-certificate-body">
                <div class="row">
                    ...
                    <div class="col-lg-12 mt-2">
                        <div class="row d-flex justify-content-center">
                            <div class="col-lg-8 text-center">
                                ...
                                <h3 class="fw-bold large" style="color: #a50c0a;">{{@$user->first_name}}</h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="row d-flex justify-content-center">
                            <div class="col-lg-8 text-center">
                                <p class="">Has successfully completed 20hr of the following Data Sc.
                                    :</p>
                ...
                <div class="row d-flex justify-content-between mt-4">
                    <div class="col-lg-6 text-center">
                        ...
                        <p class="" style="color: #4c5052;">08-02-2024</p>
                    </div>
                    <div class="col-lg-6 text-center">
