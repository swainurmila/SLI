            ...
            <div class="pm-certificate-body">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="row d-flex justify-content-center">
                            <div class="col-lg-8 text-center">
                                <p class="">He/She has successfully completed {{@$traing_data->training_duration}} {{@$traing_data->training_duration_type}} of the following {{$traing_data->name}}
                                    </p>
                ...
                <div class="row d-flex justify-content-between mt-4">
                    <div class="col-lg-6 text-center">
                        ...
                        <p class="" style="color: #4c5052;">{{Carbon\Carbon::today()->toFormattedDateString()}}</p>
                    </div>
                    <div class="col-lg-6 text-center">
