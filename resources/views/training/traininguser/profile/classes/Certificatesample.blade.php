        ...
        <div class="pm-certificate-border col-lg-12">
                    ...
                    <div class="col-lg-12">
                        <div class="row d-flex justify-content-center">
                            <div class="pm-certificate-name col-lg-8 text-center">
                                ...
                                <span class="pm-name-text bold large" style="color: #0e70b3;">Manaswinee Sahoo</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="row d-flex justify-content-center">
                            <div class="pm-earned col-lg-8 text-center">
                                <span class="m-2 padding-0 block">Has successfully completed 20.0 hours of the following
                                    professional development course:</span>
                                <span class="pm-name-text bold medium" style="color: #f7a915;">Software
                                    Development</span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row d-flex justify-content-between">
                <div class="col-lg-6 pm-certified text-center">
                    ...
                    <span class="block" style="color: #4c5052;">08-02-2024</span>
                </div>
                <div class="col-lg-6 pm-certified text-center">
