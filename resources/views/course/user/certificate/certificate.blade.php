        ...
        <div class="pm-certificate-border col-lg-12">
                    ...
                    <div class="col-lg-12">
                        <div class="row d-flex justify-content-center">
                            <div class="pm-earned col-lg-8 text-center">
                                <span class="m-2 padding-0 block">He/She has  successfully completed the {{$course->Course->course_name}} course, showcasing remarkable proficiency.
                                    </span>
            ...
            <div class="row d-flex justify-content-between">
                <div class="col-lg-6 pm-certified text-center">
                    ...
                    <span class="block" style="color: #4c5052;">{{$certified_date->updated_at->format('M j, Y')}}</span>
                </div>
                <div class="col-lg-6 pm-certified text-center">
