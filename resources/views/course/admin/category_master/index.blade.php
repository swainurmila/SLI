...
@section('content')
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row m-2">
                <div class="col-10">
                    <div class="">
                        <h4 class="mb-0 "> <b>Course Category</b> </h4>
                    </div>
                </div>

                <div class="col-2">
                    <button class="btn ms-auto btn-md custom-btn" type="button" data-bs-toggle="modal"
                        data-bs-target="#addModal">Add Course Category</button>
                </div>
            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-centered table-nowrap mb-0" id="course_category_datatable">
                                            ...
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    ...
                                                    <form id="delete-form-{{ $item->id }}"
                                                        action="{{ route('course-delete-category', [$item->id]) }}"
                                                ...
                                                <div class="modal fade" id="editTranModal{{ @$item->id }}"
                                                    ...
                                                    <div class="modal-dialog modal-l modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <form action="{{ route('course-category-update', $item->id) }}"
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-12 mb-2">
                                                                            <div class="form-group">
                                                                                <label class="form-label">Course Catagory
                                                                                    Title:<sup><span
                                                                                            style="color: red;">*</span></sup></label>
                                                                                <input type="text"
                                                                                    id="exampleInputUsername"
                                                                                    class="form-control" name="name"maxlength="60"
    ...
    <div class="modal fade" id="addModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-l modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Add Course Category</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                    </button>
                </div>

                <form action="{{ route('course-category-store') }}" method="POST" id="course-category-form"
                    enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                <div class="form-group">
                                    <label class="form-label">Course Category Title:<sup><span
                                                style="color: red;">*</span></sup></label>
                                    <input type="text" id="exampleInputUsername" class="form-control" name="name"
                                        id="name" placeholder="Course Category Title" required="required"
                                        maxlength="60">
                                    @if ($errors->has('name'))
...
@section('script')
    <script>
        $(document).ready(function() {
            $('#course_category_datatable').DataTable();
