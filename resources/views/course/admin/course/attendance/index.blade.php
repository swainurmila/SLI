                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="panel-container show">
                                <div class="panel-content">
                                    ...
                                    <div style="display: flex; justify-content: flex-end;">
                                        <a href="{{ url()->previous() }}" class="btn custom-btn">Back</a>
                                    </div>

                                    <div class="row mb-4">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="form-label">Class Mode :
                                                    <span class="text-capitalize">{{ @$class_data->class_mode }}</span>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="form-label">Class Name :
                                                    <span
                                                        class="text-capitalize">{{ @$class_data->class_name }}</span></label>
                                            </div>
                                        </div>

                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="form-label">Class Date :
                                                    {{ @$class_data->class_date }}</label>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            @if ($class_count != 0 && $attendance_count == 0)
                                <form action="{{ route('course.store-class-attendance') }}" method="POST"
                                    id="attendance_save" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                            @endif
                            <input type="hidden" id="course_id" value="{{ @$class_data->course_id }}" name="course_id">
                            <input type="hidden" id="syllabus_id" value="{{ @$class_data->syllabus_id }}"
                                name="syllabus_id">
                            ...
                            <div class="table-responsive">
                                <table class="table table-centered table-nowrap mb-0">
                                    ...
                                    @if ($class_data->attendance->isEmpty())
                                        <tbody>
                                            @php
                                                $counter = 0;
                                            @endphp
                                            @foreach ($class_data->enrollDetails as $key => $value)
                                                <tr>
                                                    <td style="text-align: center;">{{ ++$counter }} </td>
                                                    <td style="text-align: center;">{{ $value->UserData->first_name }}</td>
                                                    ...
                                                    <td style="text-align: center;">
                                                        ...
                                                        <input type="hidden" id="student_id{{ $key }}"
                                                            value="{{ $value->UserData->id }}"
                                                            name="student_id_{{ $key }}">
                                                        <span id="time_error{{ $counter }}"
                                                            style="color:red; display:none;">Check-out time must be greater
                                                            than check-in time. </span>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    @else
                                        <tbody>
                                            @foreach ($class_data->enrollDetails as $key => $value)
                                                {{-- {{dd($value->UserData->Cr_Attendance->attendance_type)}} --}}
                                                <tr>
                                                    <td style="text-align: center;">{{ ++$key }} </td>

                                                    <td style="text-align: center;"> {{ $value->UserData->first_name }}
                                                    </td>
                                                    <td style="text-align: center;">
                                                        @if (isset($value->UserData) && isset($value->UserData->Cr_Attendance))
                                                            @if ($value->UserData->Cr_Attendance->attendance_type == 1)
                                                                Present
                                                            @elseif ($value->UserData->Cr_Attendance->regularization_remark != null)
                                                                {{ $value->UserData->Cr_Attendance->regularization_remark }}
                                                            @else
                                                                Absent
                                                            @endif
                                                        @else
                                                    ...
                                                    <td style="text-align: center;">
                                                        @if (isset($value->UserData) && isset($value->UserData->Cr_Attendance))
                                                            @if ($value->UserData->Cr_Attendance->attendance_type == 1)
                                                                Check-in:{{ $value->UserData->Cr_Attendance->check_in }}
                                                                <br>
                                                                Check-out:{{ $value->UserData->Cr_Attendance->check_out }}
                                                            @else
                                                                @if ($value->UserData->Cr_Attendance->regularization_remark != null)
                                                                    @if (Auth::user()->role_id == 4)
                                                                        <a class="btn custom-btn btn-sm" title="Edit"
                                                                            data-bs-toggle="modal"
                                                                            data-bs-target="#editTranModal{{ @$value->UserData->Cr_Attendance->id }}">
                                                                            <span>R</span>
                                                                        </a>
                                                                    @else
                                                                        <a class="btn custom-btn btn-sm" title="Edit"
                                                                            data-bs-toggle="modal"
                                                                            data-bs-target="#noteditTranModal{{ @$value->UserData->Cr_Attendance->id }}">
                                                                            <span>R</span>
                                                                        </a>
                                                                    @endif
                                                                    ...
                                                                    <div class="modal fade"
                                                                        id="editTranModal{{ @$value->UserData->Cr_Attendance->id }}"
                                                                        ...
                                                                        <div class="modal-dialog modal-m modal-dialog-centered"
                                                                            ...
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <form
                                                                                    action="{{ route('course.submit-regularization', @$value->UserData->Cr_Attendance->id) }}"
                                                                                    method="POST"
                                                                                    id="regularization{{ @$value->UserData->Cr_Attendance->id }}"
                                                                                        ...
                                                                                        <div class="mb-3 row">
                                                                                            <div
                                                                                                ...
                                                                                                <label for=""
                                                                                                    ...
                                                                                                    Type</label>
                                                                                                <select
                                                                                                    class="form-select form-valid{{ $value->UserData->Cr_Attendance->id }}"
                                                                                                    id="attendance_type"
                                                                                                    onchange="changeClassregu(this,{{ $value->UserData->Cr_Attendance->id }})"
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <label
                                                                                                    ...
                                                                                                    time:</label>
                                                                                                <input type="time"
                                                                                                    id="clock_in_time{{ $value->UserData->Cr_Attendance->id }}"
                                                                                                    class="form-control"
                                                                                                    name="clock_in_time">
                                                                                            </div>
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <label
                                                                                                    ...
                                                                                                    time:</label>
                                                                                                <input type="time"
                                                                                                    id="clock_out_time{{ $value->UserData->Cr_Attendance->id }}"
                                                                                                    class="form-control"
                                                                                                    name="clock_out_time">
                                                                                            </div>
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <input
                                                                                                    class="form-control form-valid{{ $value->UserData->Cr_Attendance->id }}"
                                                                                                    type="text"
                                                                                                    value=""
                                                                                                    id="remark{{ $value->UserData->Cr_Attendance->id }}"
                                                                                                    name="remark">
                                                                                            </div>
                                                                                    ...
                                                                                    <div class="modal-footer">
                                                                                        ...
                                                                                        <button type="button"
                                                                                            onclick="saveFormedit({{ $value->UserData->Cr_Attendance->id }})"
                            ...
                            @if ($class_data->attendance->isEmpty())
                                <button type="submit" onclick="attendanceSave()" id="assignmentSave"
                                    class="btn custom-btn assignmentSave">Save</button>
                            @endif
                            </form>
