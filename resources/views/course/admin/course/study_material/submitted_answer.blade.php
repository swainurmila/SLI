    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row m-2">
                ...
                <div class="col-1">
                    <a href="{{ route('course.admin.course-view', $data->course_id) }}" class="btn ms-auto btn-md custom-btn">
                        Back</a>
                </div>
                                        ...
                                        <tbody>
                                            @if (!$data->Answers->isEmpty())
                                                @foreach ($data->Answers as $key => $answer)
                                                    <form id="assignment_result"
                                                        action="{{ route('course.admin.store-assignment-mark', $data->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        <tr class="text-center">
                                                            <td>{{ ++$key }}</td>
                                                            <td class="text-capitalize">{{ @$answer->User->first_name }}
                                                                {{ @$answer->User->last_name }}</td>
                                                            <td>{{ @$answer->User->email }}</td>
                                                            <td>{{ @$answer->User->contact_no }}</td>
                                                            <td>
                                                                <a download="{{ @$answer->User->first_name }} {{ @$answer->User->last_name }}.pdf"
                                                                    href="{{ @$answer->assignment_answer }}">Download</a>
                                                            </td>
                                                            <td>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#assignment_result").validate({
                ...
                messages: {
                    result: {
                        required: "Please enter a result",
